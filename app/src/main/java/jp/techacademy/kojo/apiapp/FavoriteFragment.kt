package jp.techacademy.kojo.apiapp
...
class FavoriteFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        favoriteAdapter.apply {
            ...
            onClickItem = {
                /*
                fragmentCallback?.onClickItem(it.url, it.id)

                 */
                val shop: Shop = Shop(it.address, CouponUrls(it.url, it.url), it.id, it.imageUrl, it.name)
